...
async fn main() {
    ...
    let tilemap = load_texture("/home/derpyzza/projects/ledit/assets/test_tileset16.png").await.expect("tilemap not found");
    ...
    loop {
        ...
        if DEBUG {
            ...
            draw_text(format!("({}:{})", mpos.x, mpos.y).as_str(),
            mpos.x + 20., mpos.y - 10., 20., c);
