...
use macroquad::{color::*, input::*, math::*, shapes::*, text::draw_text, texture::*, window::*};
...
impl Room {
    ...
    pub fn draw(&self, world: &World, game: &Game) {
        ...
        for tile in &self.tiles {
            ...
            let tile_pos: Vec2 = {
                let mut level_coords = vec2(
                    // transform cell data to grid coords.
            ...
            game.draw_tile(tile.0, tile_pos.x, tile_pos.y, self, world);
        }
